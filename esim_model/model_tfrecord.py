...
class ESIM(object):
    def __init__(self, args):
        self._parameter_init(args)

        self.embed_matrix = tf.Variable(tf.random_uniform([self.n_vocab, self.embedding_size], -1.0, 1.0),
                                        name="embed_matrix")
    ...
    def _parameter_init(self, args):
        self.seq_length = args.sentence_len
    ...
    def build(self, premise, premise_mask, hypothesis, hypothesis_mask, dropout_keep_prob):
